...
public class AlphaBetaChess {
   ...
   * Due to this strategy we can avoid writing a lot of duplicate code of checking other person's move during depth search*/
  ...
  //Basically we are puting everything back in place, this is what gets executed when we want to undo a move.
    ...
    public static String posibleP(int i) {
        ...
        int r=i/8, c=i%8;
        for (int j=-1; j<=1; j+=2) {
            try {//capture																	//check diagonally in front direction if something could be captured.
  ...
  //we will move the piece 1 step in one direction and 2 steps in another direction. we will have 2 try blocks each taking care of pieces at alternate location.

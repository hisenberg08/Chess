...
public class Rating {
	...
	//all these matrices are points that we allocate to a piece when it is at a particular position on the board.   
	static int pawnBoard[][]={//attribute to http://chessprogramming.wikispaces.com/Simplified+evaluation+function
	    ...
	    //this method rates the pieces. This helps in deciding which move to make.
	    ...
	    //this method prioritizes check, checkmate and stalemate conditions over the other.
	    ...
	    //this method rates the piece based on the location it is at on the board.
